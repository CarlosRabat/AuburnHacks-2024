...
def display_top_tracks(artist_name):
    ...
    for track_info in tracks:
        ...
        top_tracks.append(
            {"name": track_name, "popularity": track_popularity, "artists": artists}
        )
...
top_tracks = display_top_tracks("ACDC")
print(top_tracks)

# Display top tracks
# for i, track in enumerate(top_tracks, start=1):
#    print(
#        f"{i}. {track['name']} by {', '.join(track['artists'])} - Popularity: {track['popularity']}"
#    )
